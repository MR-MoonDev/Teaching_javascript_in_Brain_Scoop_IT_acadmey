...
function displayMessageWithoutParameter() {
  document.getElementById("fun").innerHTML += "FUNCTION WITHOUT PARAMETER</br>";
}
...
document.getElementById(
  "fun2"
).innerHTML += `Arrow function without parameter ${arr_fun_holder}</br>`;
...
document.getElementById(
  "fun2"
).innerHTML += `Arrow function with parameter ${arrow_fun_with_parameter_holder}</br>`;
